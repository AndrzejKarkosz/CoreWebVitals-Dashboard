...
from google.analytics.data_v1beta.types import (
  ...
  script_path = '~/projects/looker-studio-pyscripts/Core Web Vitals/Core_Web_Vitals_INP_ETL.py'
  ...
  #Set-up logs
  logging.basicConfig(filename = 'INP_ETL_logs.log', level = logging.INFO, format = '%(asctime)s - %(message)s', datefmt = '%d-%b-%y %H:%M:%S1')
  ...
  request = RunReportRequest(
        ...
        dimensions=[
          ...
          Dimension(name="customEvent:event_target"),
...
df_combined.rename(columns = {'customEvent:event_target': 'event_target'}, inplace = True)
...
schema=[
        ...
        bigquery.SchemaField("event_target","STRING", mode="REQUIRED"),
